...
var urlBase = "/admin/admin_ajax.php";
var formVars = "";
var changing = false;
...
function fieldEnter(campo,evt,idfld) {
	...
	if (evt.keyCode == 13 && campo.value!="") {
		...
		nt = remotos.enviar(urlBase + "?field_name=" +encodeURIComponent(elem.id)+ "&call_content="+encodeURIComponent(campo.value)+"&"+formVars,"");
		//remove glow
		noLight(elem);
		elem.innerHTML = nt;
		changing = false;
