...
class SimpleCaptcha {
     ...
     *
     */
    public $resourcesPath = LIBS_PATH;
    ...
    public $backgroundColor = array(252, 252, 252);

    /** Foreground colors in RGB-array */
    public $colors = array(
        array(27,78,181), // blue
        array(112,5,112), // green
        array(4,44,144),  // red
    );
     ...
     */
    public $fonts = array(
       // 'Antykwa'  => array('spacing' => -3, 'minSize' => 20, 'maxSize' => 25, 'font' => 'AntykwaBold.ttf'),
       ...
       // 'Duality'  => array('spacing' => -2, 'minSize' => 22, 'maxSize' => 26, 'font' => 'Duality.ttf'),
       // 'Heineken' => array('spacing' => -2, 'minSize' => 20, 'maxSize' => 24, 'font' => 'Heineken.ttf'),
        //'Jura'     => array('spacing' => -2, 'minSize' => 20, 'maxSize' => 24, 'font' => 'Jura.ttf'),
       // 'StayPuft' => array('spacing' =>-1.5,'minSize' => 20, 'maxSize' => 24, 'font' => 'StayPuft.ttf'),
        'Times'    => array('spacing' => 2, 'minSize' => 18, 'maxSize' => 18, 'font' => 'Times_New_Roman_Bold.ttf'),
    ...
    protected function GetRandomCaptchaText($length = null) {
        ...
        $vocals = "abcdefghijlmnopqrstvwyz1234567890";

        $text  = "";
        for ($i=0; $i<$length; $i++) {
             $text .= substr($vocals, mt_rand(0, 32), 1);
        }
        return $text;
    }
    ...
    protected function WriteImage() {
        if ($this->imageFormat == 'png' && function_exists('imagepng')) {
            ...
            imagejpeg( $this->im, null, Config::get('jpeg_compress') );
        }
    }
