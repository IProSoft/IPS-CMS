...
class GDEnhancer {
   ...
   public function layerText($text, $fontfile, $fontsize, $fontcolor, $opacity = 100, $angle = 0, $linespacing = 1) {
      $this->actions->layerText($text, $fontfile, $fontsize, $fontcolor, $opacity, $angle, $linespacing);
   }
