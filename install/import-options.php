...
return array(
	'system_settings' => array(
		array (
			'settings_name' => 'add_captcha',
			'settings_value' => '1',
			'autoload' => 'yes',
		),
		array (
			'settings_name' => 'add_extra_description',
			'settings_value' => 'all_users',
			'autoload' => 'yes',
		),
		array (
			'settings_name' => 'add_filename_date',
			'settings_value' => '1',
			'autoload' => 'yes',
		),
		array (
			'settings_name' => 'add_is_adult_field',
			'settings_value' => '0',
			'autoload' => 'yes',
		),
		array (
			'settings_name' => 'add_max_file_size',
			'settings_value' => '5',
			'autoload' => 'yes',
		),
		array (
			'settings_name' => 'add_private_files',
			'settings_value' => '0',
			'autoload' => 'yes',
		),
		array (
			'settings_name' => 'add_require_rules',
			'settings_value' => '1',
			'autoload' => 'yes',
		),
		array (
			'settings_name' => 'add_source',
			'settings_value' => '1',
			'autoload' => 'yes',
		),
		array (
			'settings_name' => 'add_thumb_size',
		...
		array (
			'settings_name' => 'admin_alerts',
			'settings_value' => array (
			),
			'autoload' => 'yes',
		),
		array (
			'settings_name' => 'admin_lang_locale',
			'settings_value' => 'pl_PL',
			'autoload' => 'yes',
		),
		array (
			'settings_name' => 'admin_last_visit_stats',
			'settings_value' => array (
				'count_stats_shares' => 0,
				'current_date' => '2016-01-06 12:24:44',
				'count_stats_register' => 0,
				'count_stats_files' => 0,
				'count_all_shares' => 15,
				'count_all_users' => 4,
				'count_all_files' => 15,
				'count_stats_comments' => 0,
				'count_all_comments' => 0,
			),
			'autoload' => 'yes',
		),
		array (
			'settings_name' => 'ads_frequency',
			'settings_value' => array (
				'between_files' => '5',
				'between_comments' => '5',
				'between_popular_posts' => '5',
			),
			'autoload' => 'yes',
		),
		array (
			'settings_name' => 'adult_files',
			'settings_value' => '0',
			'autoload' => 'yes',
		),
		array (
			'settings_name' => 'ajax_notify',
			'settings_value' => '0',
			'autoload' => 'yes',
		),
		array (
			'settings_name' => 'analytics_enabled',
			'settings_value' => 0,
			'autoload' => 'yes',
		),
		array (
			'settings_name' => 'animation_options',
			'settings_value' => array (
				'width' => '300',
				'height' => '300',
				'const_size' => '0',
		...
		array (
			'settings_name' => 'app_css_files',
			'settings_value' => array (
				'minify' => array (
					 0 => 'widgets/widget_best_files.css',
					 1 => 'autosuggest.css',
					 2 => 'widgets/widget_user_idle.css',
					 3 => 'widgets/widget_cookie_info.css',
					 4 => 'dialogs/humanity/dialog.css',
					 5 => 'pagination/pagin_infinity.css',
					 6 => 'swobject.css',
					 7 => '__common/css/common.css',
					 8 => 'style.css',
				),
				'path' => array (
					 0 => 'css/widgets/widget_best_files.css',
					 1 => 'css/autosuggest.css',
					 2 => 'css/widgets/widget_user_idle.css',
					 3 => 'css/widgets/widget_cookie_info.css',
					 4 => 'css/dialogs/humanity/dialog.css',
					 5 => 'css/pagination/pagin_infinity.css',
					 6 => 'css/swobject.css',
					 7 => 'templates/__common/css/common.css',
					 8 => 'templates/gag/css/style.css',
				),
			),
			'autoload' => 'yes',
		),
		array (
			'settings_name' => 'app_javascript_files',
			'settings_value' => array (
				'minify' => array (
					 0 => 'libraries.js',
					 1 => 'app.js',
					 2 => 'scripts.js',
					 3 => 'scroll/jquery.stickyscroll.js',
					 4 => 'paginator.js',
					 5 => 'widgets/widget_cookie_info.js',
					 6 => 'widgets/widget_user_idle.js',
					 7 => 'widgets/widget_best_files.js',
					 8 => 'functions.gag.js',
				),
				'path' => array (
					 0 => 'js/libraries.js',
					 1 => 'js/app.js',
					 2 => 'js/scripts.js',
					 3 => 'js/scroll/jquery.stickyscroll.js',
					 4 => 'js/paginator.js',
					 5 => 'js/widgets/widget_cookie_info.js',
					 6 => 'js/widgets/widget_user_idle.js',
					 7 => 'js/widgets/widget_best_files.js',
					 8 => 'js/functions.gag.js',
				),
			),
			'autoload' => 'yes',
		),
		array (
			'settings_name' => 'apps_auto_login_enabled',
			'settings_value' => array (
				'facebook' => '0',
				'nk' => '0',
				'twitter' => '0',
		...
		array (
			'settings_name' => 'apps_facebook_app',
			'settings_value' => array (
				'app_id' => '',
				'app_secret' => '',
				'app_version' => 'v2.4',
		...
		array (
			'settings_name' => 'apps_facebook_autopost',
			'settings_value' => '1',
			'autoload' => 'yes',
		),
		array (
			'settings_name' => 'apps_facebook_autopost_options',
			'settings_value' => array (
				'count' => '2',
				'wait_time' => '0',
				'auto_block' => '0',
		...
		array (
			'settings_name' => 'apps_fanpage_auto',
			'settings_value' => array (
				'image_info' => 'orginal',
				'image' => '',
				'title_info' => 'user',
		...
		array (
			'settings_name' => 'apps_fanpage_default',
			'settings_value' => '',
			'autoload' => 'yes',
		),
		array (
			'settings_name' => 'apps_fanpage_default_id',
			'settings_value' => '',
			'autoload' => 'yes',
		),
		array (
			'settings_name' => 'apps_fanpage_default_token',
			'settings_value' => '',
			'autoload' => 'yes',
		),
		array (
			'settings_name' => 'apps_fanpage_post_added',
			'settings_value' => '1',
			'autoload' => 'yes',
		),
		array (
			'settings_name' => 'apps_fanpage_post_move_main',
			'settings_value' => '2',
			'autoload' => 'yes',
		),
		array (
			'settings_name' => 'apps_fanpage_posting',
			'settings_value' => array (
				'on_upload' => 0,
				'on_upload_count' => 2,
		...
		array (
			'settings_name' => 'apps_get_thumbnail',
			'settings_value' => '1',
			'autoload' => 'yes',
		),
		array (
			'settings_name' => 'apps_google_maps_customize',
			'settings_value' => '0',
			'autoload' => 'yes',
		),
		array (
			'settings_name' => 'apps_login_enabled',
			'settings_value' => array (
				'facebook' => 0,
				'twitter' => 0,
				'nk' => 0,
		...
		array (
			'settings_name' => 'apps_social_lock',
			'settings_value' => '1',
			'autoload' => 'yes',
		),
		array (
			'settings_name' => 'apps_social_lock_options',
			'settings_value' => array (
				'count' => '2',
				'wait_time' => '1',
				'auto_block' => '0',
		...
		array (
			'settings_name' => 'apps_twitter_app',
			'settings_value' => array (
				'consumer_key' => '',
				'consumer_secret' => '',
				'username' => '',
		...
		array (
			'settings_name' => 'cache_data_categories',
			'settings_value' => array (
				'PL' => array (
					 1 =>   array (
					 	'id_category' => '1',
					 	'category_name' => 'Uncategorized',
					 	'category_name_dupiaty' => '',
					 	'category_name_fr' => '',
					 	'category_name_en' => '',
					 	'category_name_pl' => '',
					 	'category_image' => 'uncategorized.png',
					 	'only_adult' => '0',
					 	'only_premium' => '0',
					 	'only_logged_in' => '0',
					 	'is_default_category' => '1',
					 	'category_link' => 'uncategorized.html',
					 ),
				),
			),
			'autoload' => 'yes',
		...
		array (
			'settings_name' => 'cache_data_categories_PL',
			'settings_value' => array (
			),
			'autoload' => 'yes',
		),
		array (
			'settings_name' => 'cache_data_menus',
			'settings_value' => array (
				'main_menu_pl' => '	<li class=""><a href="/top/" title="{lang=menu_top}" target="_blank"><i class="i-m"></i>{lang=menu_top_menu}</a></li>
		',
				'gag_sub_menu_pl' => '<ul id="menu-navigation" class="responsive-menu content-submenu-items">
			<li class="add-file"><a href="/up/" title="{lang=menu_up}"><i class="i-m"></i>{lang=menu_up_menu}</a></li>
			<li class=""><a href="/waiting/" title="{lang=menu_waiting}"><i class="i-m"></i>{lang=menu_waiting_menu}</a></li>
			<li class=""><a href="/" title="{lang=menu_main}"><i class="i-m"></i>{lang=menu_main_menu}</a></li>
		</ul>
		',
				'footer_menu_pl' => '	<li class=""><a href="/pages/regulamin.html" title="{lang=common_rules}"><i class="i-m"></i>{lang=common_rules}</a></li>
			<li class=""><a href="/pages/reklama.html" title="{lang=bottom_ads}"><i class="i-m"></i>{lang=bottom_ads}</a></li>
			<li class=""><a href="/news/" title="{lang=bottom_news}"><i class="i-m"></i>{lang=bottom_news}</a></li>
		',
			),
			'autoload' => 'yes',
		),
		array (
			'settings_name' => 'cache_data_posts',
			'settings_value' => array (
				0 => array (
					'post_title' => 'Regulamin',
					'post_permalink' => 'regulamin.html',
					'post_type' => 'pages',
					'post_visibility' => 'public',
				),
				1 => array (
					'post_title' => 'Reklama',
					'post_permalink' => 'reklama.html',
					'post_type' => 'pages',
					'post_visibility' => 'public',
				),
			),
		...
		array (
			'settings_name' => 'cache_data_valid_facebook_config',
			'settings_value' => array (
			),
			'autoload' => 'yes',
		),
		array (
			'settings_name' => 'cache_data_valid_nk_config',
			'settings_value' => array (
			),
			'autoload' => 'yes',
		),
		array (
			'settings_name' => 'categories_option',
			'settings_value' => '1',
			'autoload' => 'yes',
		),
		array (
			'settings_name' => 'categories_options',
			'settings_value' => array (
				'sorting' => 'id',
				'thumb_size' => '100',
			),
		...
		array (
			'settings_name' => 'comments_options',
			'settings_value' => array (
				'type' => 'ajax_facebook',
				'as_image' => '0',
				'as_video' => '1',
				...
				'below_vote' => '1',
				'flooding_time' => '1',
				'comments_facebook_color_scheme' => 'dark',
				'allways_visible' => '1',
				'emots_type' => 'light',
			),
			'autoload' => 'yes',
		...
		array (
			'settings_name' => 'contest_option',
			'settings_value' => '0',
			'autoload' => 'yes',
		),
		array (
			'settings_name' => 'contest_option_count',
			'settings_value' => '0',
			'autoload' => 'yes',
		),
		array (
			...
			'settings_value' => array (
				1441641600 => array (
					'c3077d3c5de7ee37a1d09ed4714facd2' =>   array (
					 	'id' => 'c3077d3c5de7ee37a1d09ed4714facd2',
					 	'timestamp' => 1441641600,
					...
					'a4d507a65ebd1562b43572375f0b8ce3' =>   array (
					 	'id' => 'a4d507a65ebd1562b43572375f0b8ce3',
					 	'timestamp' => 1441641600,
					 	'function-name' => 'archive_wait',
					 	'schedule' => 'hourly',
					 	'args' =>     array (
					 		'count' => 1,
					 	),
					...
					'd17562503b9ea8a23eadc59435d58dfd' =>   array (
					 	'id' => 'd17562503b9ea8a23eadc59435d58dfd',
					 	'timestamp' => 1441641600,
					...
					'89619d349e1bb38b931469fa3d2977bd' =>   array (
					 	'id' => '89619d349e1bb38b931469fa3d2977bd',
					 	'timestamp' => 1441641600,
					 	'function-name' => 'import',
					 	'schedule' => 'hourly',
					 	'args' =>     array (
					 		'count' => 1,
					 		'import_directory' => '/upload/tmp',
					 		'users' => 'baron, leon, wieś, lula, dom',
					 		'import_sorting' => 'desc',
					 		'import_category' => 1,
					 		'import_default_name' => '',
					 		'import_add_to' => 'wait',
					...
					'282a5cbf83e7bfee88c80a5ffc3c1fdf' =>   array (
					 	'id' => '282a5cbf83e7bfee88c80a5ffc3c1fdf',
					 	'timestamp' => 1441641600,
					 	'function-name' => 'import_drafts',
					 	'schedule' => 'hourly',
					 	'args' =>     array (
					 		'count' => 1,
					 		'import_add_to' => 'wait',
					...
					'a6a8bbe601d9312df9745f44bdbc52ea' =>   array (
					 	'id' => 'a6a8bbe601d9312df9745f44bdbc52ea',
					 	'timestamp' => 1441641600,
					...
					'a2f7eb7c936a45ea69f3b9c73182fd11' =>   array (
					 	'id' => 'a2f7eb7c936a45ea69f3b9c73182fd11',
					 	'timestamp' => 1441641600,
					 	'function-name' => 'move-to-main',
					 	'schedule' => 'hourly',
					 	'args' =>     array (
					 		'count' => 1,
					 		'votes_count' => 1,
					...
					'79c5e91a6f57991a7a17aad73261c26c' =>   array (
					 	'id' => '79c5e91a6f57991a7a17aad73261c26c',
					 	'timestamp' => 1441641600,
					 	'function-name' => 'clear-cache',
					 	'schedule' => 'hourly',
					 	'args' =>     array (
					 		'tpl' => 0,
					 		'js' => 0,
					...
					'42a5305ff39963a56b6d5a1644a22a86' =>   array (
					 	'id' => '42a5305ff39963a56b6d5a1644a22a86',
					 	'timestamp' => 1441641600,
					 	'function-name' => 'fanpage',
					 	'schedule' => 'hourly',
					 	'args' =>     array (
					 		'type' => 'post',
					 		'options_multiple_flat' =>       array (
		...
		array (
			'settings_name' => 'cron_tasks_history',
			'settings_value' => array (
				0 => array (
					'time' => 1421862855,
					'info' => 'Dodano na Fanpage 1 materiałów',
				),
				1 => array (
					'time' => 1421862982,
					'info' => 'Dodano na Fanpage 1 materiałów',
		...
		array (
			'settings_name' => 'email_admin_user',
			'settings_value' => '',
			'autoload' => 'yes',
		),
		array (
			'settings_name' => 'email_smtp',
			'settings_value' => 0,
			'autoload' => 'yes',
		),
		array (
			'settings_name' => 'email_smtp_options',
			'settings_value' => array (
				'login' => '',
				'password' => '',
				'host' => '',
		...
		array (
			'settings_name' => 'facebook_privileges',
			'settings_value' => 'email,user_birthday,publish_actions',
			'autoload' => 'yes',
		),
		array (
			'settings_name' => 'favourites_add',
			'settings_value' => '1',
			'autoload' => 'yes',
		),
		array (
			'settings_name' => 'file_max_width',
			'settings_value' => '600',
			'autoload' => 'yes',
		),
		array (
			'settings_name' => 'files_on_page',
			'settings_value' => '10',
			'autoload' => 'yes',
		),
		array (
			'settings_name' => 'footer_code',
			'settings_value' => '',
			'autoload' => 'yes',
		),
		array (
			'settings_name' => 'gallery_description_length',
			'settings_value' => '10',
			'autoload' => 'yes',
		),
		array (
			'settings_name' => 'gallery_images_count',
			'settings_value' => '0',
			'autoload' => 'yes',
		),
		array (
			'settings_name' => 'gallery_load',
			'settings_value' => 'pirobox',
			'autoload' => 'yes',
		),
		array (
			'settings_name' => 'gallery_load_img_before',
			'settings_value' => '1',
			'autoload' => 'yes',
		),
		array (
			'settings_name' => 'gallery_local',
			'settings_value' => '0',
			'autoload' => 'yes',
		),
		array (
			'settings_name' => 'gallery_options',
			'settings_value' => array (
				'local' => '0',
				'watermark' => '1',
		...
		array (
			'settings_name' => 'gallery_upload_first_file',
			'settings_value' => '1',
			'autoload' => 'yes',
		),
		array (
			'settings_name' => 'gallery_watermark',
			'settings_value' => '0',
			'autoload' => 'yes',
		),
		array (
			'settings_name' => 'gif_auto_play',
			'settings_value' => '0',
			'autoload' => 'yes',
		),
		array (
			'settings_name' => 'head_code',
			'settings_value' => '',
			'autoload' => 'yes',
		),
		array (
			'settings_name' => 'hooks_actions_registry',
			'settings_value' => array (
				'before_content' => array (
					 0 =>   array (
					 	...
					 	'key' => 'before_content_widget_sort_box',
					 ),
					 1 =>   array (
					 	'hook' => 'before_content',
					 	'function' => 'Session::getFlash',
					 	'params' => NULL,
					 	'priority' => 3,
					 	'key' => 'Session::getFlash',
					 ),
					 2 =>   array (
					 	'hook' => 'before_content',
					 	'function' => 'call_widget',
					 	...
					 	'priority' => 4.9000000000000003552713678800500929355621337890625,
					 	'key' => 'before_content_widget_best_files',
					 ),
					 3 =>   array (
					 	'hook' => 'before_content',
					 	'function' => 'call_widget',
					 	'params' =>     array (
					     0 => 'widgetCached',
					     1 => 'widget_history_users_activity',
					     2 => 'usersHistoryActivity',
					 	),
					 	'priority' => 5.9000000000000003552713678800500929355621337890625,
					 	'key' => 'before_content_widget_history_users_activity',
					 ),
				),
				'at_side_block' => array (
					 0 =>   array (
					 	'hook' => 'at_side_block',
					 	'function' => 'callable_action_ads',
					 	'params' =>     array (
					     0 => 'side_block_top',
					 	),
					 	'priority' => 2.100000000000000088817841970012523233890533447265625,
					 	'key' => 'at_side_block_side_block_top',
					 ),
					 1 =>   array (
					 	'hook' => 'at_side_block',
					 	'function' => 'call_widget',
					 	...
					 	'priority' => 2.899999999999999911182158029987476766109466552734375,
					 	'key' => 'at_side_block_widget_personalize',
					 ),
					 2 =>   array (
					 	'hook' => 'at_side_block',
					 	'function' => 'call_widget',
					 	...
					 	'priority' => 3.899999999999999911182158029987476766109466552734375,
					 	'key' => 'at_side_block_widget_fan_box',
					 ),
					 3 =>   array (
					 	'hook' => 'at_side_block',
					 	'function' => 'call_widget',
					 	'params' =>     array (
					     0 => 'widgetCached',
					     1 => 'widget_popular_tags',
					     2 => 'popularTags',
					 	),
					 	'priority' => 4.9000000000000003552713678800500929355621337890625,
					 	'key' => 'at_side_block_widget_popular_tags',
					 ),
					 4 =>   array (
					 	'hook' => 'at_side_block',
					 	'function' => 'call_widget',
					 	'params' =>     array (
					     0 => 'connectButton',
					     1 => 'widget_side_action_button',
					 	),
					 	'priority' => 5.9000000000000003552713678800500929355621337890625,
					 	'key' => 'at_side_block_widget_side_action_button',
					 ),
					 5 =>   array (
					 	'hook' => 'at_side_block',
					 	'function' => 'call_widget',
					 	...
					 	'priority' => 6.9000000000000003552713678800500929355621337890625,
					 	'key' => 'at_side_block_widget_popular_posts',
					 ),
					 6 =>   array (
					 	'hook' => 'at_side_block',
					 	'function' => 'call_widget',
					 	...
					 	'priority' => 7.9000000000000003552713678800500929355621337890625,
					 	'key' => 'at_side_block_widget_small_posts',
					 ),
					 7 =>   array (
					 	'hook' => 'at_side_block',
					 	'function' => 'callable_action_ads',
					 	...
					 	'priority' => 10,
					 	'key' => 'at_side_block_side_block_bottom',
					 ),
				),
				'load' => array (
					 0 =>   array (
					 	'hook' => 'load',
					 	'function' => 'callable_plugin',
					 	'params' =>     array (
					 		'plugin' => 'Sticked',
					 		'actions' =>       array (
					       0 => 'uploading',
		...
		array (
			'settings_name' => 'image_captcha_size',
			'settings_value' => array (
				'font' => 'Nosifer',
				'min' => '8',
				'max' => '14',
		...
		array (
			'settings_name' => 'img_preloader',
			'settings_value' => '0',
			'autoload' => 'yes',
		),
		array (
			'settings_name' => 'infinity_scroll_onclick',
			'settings_value' => '1',
			'autoload' => 'yes',
		),
		array (
			'settings_name' => 'infinity_scroll_pages',
			'settings_value' => '5',
			'autoload' => 'yes',
		),
		array (
			'settings_name' => 'install_date',
			'settings_value' => '2014-12-16 23:28:12',
			'autoload' => 'no',
		),
		array (
			'settings_name' => 'ips_icheck_skin',
			'settings_value' => array (
				'skin' => 'line',
				'color' => 'blue',
			),
		...
		array (
			'settings_name' => 'ips_randomity',
			'settings_value' => '14444',
			'autoload' => 'yes',
		),
		array (
			'settings_name' => 'jquery_array',
			'settings_value' => array (
				'ips_user' => array (
					'is_logged' => false,
					'user_id' => false,
				...
				'ips_config' => array (
					...
					'app_id' => '1437772603131683',
					'app_version' => 'v2.4',
					'app_publish' => true,
					'app_status' => 'not_logged',
					'fanpage_id' => '282494891765603',
					'version' => 'gag',
					'url' => 'http://www.skrypt.ips/',
					'animation' =>   array (
					 	'show' => 'puff',
					 	'hide' => 'puff',
					 ),
		...
		array (
			'settings_name' => 'language_settings',
			'settings_value' => array (
				'default_language' => 'PL',
				'ips_multilanguage' => 1,
		...
		array (
			'settings_name' => 'license_email',
			'settings_value' => 'admin@iprosoft.pro',
			'autoload' => 'yes',
		),
		array (
			'settings_name' => 'license_hash',
			'settings_value' => 'SZDXpl5hZd0L5GxMopJLVHdgoJ0uAlsr7KT4bgLy850jaGeavKdqd1ofHxlXUTWinTCAWeYoQkEj0xP4GXtanA==',
			'autoload' => 'no',
		),
		array (
			'settings_name' => 'license_number',
			'settings_value' => 'JCWPM-LYAY4-2TPZ6-OYGKQ',
			'autoload' => 'yes',
		),
		array (
			'settings_name' => 'mailing_options',
			'settings_value' => 'normal',
			'autoload' => 'yes',
		),
		array (
			'settings_name' => 'mem_generator',
			'settings_value' => '1',
			'autoload' => 'yes',
		),
		array (
			'settings_name' => 'mod_privileges',
			'settings_value' => array (
				'main' => 1,
				'wait' => 1,
				'archive' => 1,
		...
		array (
			'settings_name' => 'module_history',
			'settings_value' => '1',
			'autoload' => 'yes',
		),
		array (
			'settings_name' => 'module_history_actions',
			'settings_value' => array (
				0 => 'view',
				1 => 'login',
				2 => 'comment',
		...
		array (
			'settings_name' => 'mp4_autoplay',
			'settings_value' => '1',
			'autoload' => 'yes',
		),
		array (
			'settings_name' => 'mp4_player',
			'settings_value' => 'video.js',
			'autoload' => 'yes',
		),
		array (
			'settings_name' => 'online_stats',
			'settings_value' => '1',
			'autoload' => 'yes',
		),
		array (
			'settings_name' => 'page_fast',
			'settings_value' => '1',
			'autoload' => 'yes',
		),
		array (
			'settings_name' => 'page_fast_options',
			'settings_value' => array (
				'widget' => 1,
				'share' => 1,
				'like' => 1,
		...
		array (
			'settings_name' => 'pagin_css',
			'settings_value' => 'infinity',
			'autoload' => 'yes',
		),
		array (
			'settings_name' => 'pagin_css_pages',
			'settings_value' => '10',
			'autoload' => 'yes',
		),
		array (
			'settings_name' => 'pinit_upload_normal',
			'settings_value' => '1',
			'autoload' => 'yes',
		),
		array (
			'settings_name' => 'pinit_upload_website',
			'settings_value' => '1',
			'autoload' => 'yes',
		),
		array (
			'settings_name' => 'plugin_sticked',
			'settings_value' => array (
				'height' => 40,
				'color' => '#ffffff',
				'file' => 'MTU2_plugin_sticked_file.png',
				'align' => 'right',
				'add_to' => array (
					 0 => 'image',
					 1 => 'mem',
		...
		array (
			'settings_name' => 'post_facebook_data',
			'settings_value' => array (
			),
			'autoload' => 'yes',
		),
		array (
			'settings_name' => 'pw_messages_admin',
			'settings_value' => '1',
			'autoload' => 'yes',
		),
		array (
			'settings_name' => 'ranking_options',
			'settings_value' => array (
				'local' => '0',
				'watermark' => '0',
				'create_image' => '1',
		...
		array (
			'settings_name' => 'recaptcha_token',
			'settings_value' => array (
				'privatekey' => '6LdFif8SAAAAAKpB7Nv4lgwBMavAVEA9NYVPEMBU',
				'publickey' => '6LdFif8SAAAAAHUdR2UZ05IHWDNKnEXzepE5wIN6',
			),
			'autoload' => 'yes',
		),
		array (
			'settings_name' => 'rss_off',
			'settings_value' => '0',
			'autoload' => 'yes',
		),
		array (
			'settings_name' => 'scroll_long_files',
			'settings_value' => '1',
			'autoload' => 'yes',
		),
		array (
			'settings_name' => 'scroll_long_files_height',
			'settings_value' => '800',
			'autoload' => 'yes',
		),
		array (
			'settings_name' => 'seo_links_format',
			'settings_value' => '1',
			'autoload' => 'yes',
		),
		array (
			'settings_name' => 'seo_links_format_pct',
			'settings_value' => '_',
			'autoload' => 'yes',
		),
		array (
			'settings_name' => 'services_premium',
			'settings_value' => '0',
			'autoload' => 'yes',
		),
		array (
			'settings_name' => 'services_premium_options',
			'settings_value' => array (
				'category' => '1',
				'add' => '1',
				'comments' => '1',
		...
		array (
			'settings_name' => 'site_in_maintenance',
			'settings_value' => '0',
			'autoload' => 'yes',
		),
		array (
			'settings_name' => 'site_in_maintenance_text',
			'settings_value' => 'Maintence',
			'autoload' => 'yes',
		),
		array (
			'settings_name' => 'site_url_prefix',
			'settings_value' => '1',
			'autoload' => 'yes',
		),
		array (
			'settings_name' => 'social_cache',
			'settings_value' => '1',
			'autoload' => 'yes',
		),
		array (
			'settings_name' => 'social_plugins',
			'settings_value' => array (
				'share_img' => '0',
				'share' => '1',
				'share_page' => '1',
		...
		array (
			'settings_name' => 'template_settings',
			'settings_value' => array (
				'side_button' => 1,
				'side_block_position' => 'right',
				'item_title' => '1',
				'side_stats' => '1',
				'item_source' => 1,
				'tips' => '1',
		...
		array (
			'settings_name' => 'update_alert_count',
			'settings_value' => '0',
			'autoload' => 'no',
		),
		array (
			'settings_name' => 'update_alert_last_time',
			'settings_value' => '1452083954',
			'autoload' => 'yes',
		),
		array (
			'settings_name' => 'update_alert_time',
			'settings_value' => '1',
			'autoload' => 'no',
		),
		array (
			'settings_name' => 'upload_allowed_html_tags',
			'settings_value' => array (
				0 => 'h2',
				1 => 'h3',
				2 => 'h4',
		...
		array (
			'settings_name' => 'upload_demot_signature',
			'settings_value' => array (
				'type' => 'off',
				'file' => '',
				'font' => 'Archivo-Black',
		...
		array (
			'settings_name' => 'upload_demotywator_text',
			'settings_value' => array (
				'font' => 'PT-Sans',
				'user_font' => 1,
				'font_color_top_line' => '#ffffff',
				'font_color_bottom_line' => '#0011ff',
				'user_color' => 1,
				'font_size_top' => '19',
				'font_size_bottom' => '16',
		...
		array (
			'settings_name' => 'upload_demotywator_type',
			'settings_value' => array (
				'image' => '1',
				'text' => '1',
				'video' => '1',
		...
		array (
			'settings_name' => 'upload_mp4_options',
			'settings_value' => array (
				'max_duration' => '7',
				'download_always' => '1',
				'cover_add' => '1',
				'extract_image' => '0',
				'default_cover' => '#ffffff',
			),
			'autoload' => 'yes',
		),
		array (
			'settings_name' => 'upload_tags',
			'settings_value' => 1,
			'autoload' => 'yes',
		),
		array (
			'settings_name' => 'upload_tags_options',
			'settings_value' => array (
				'extract' => 0,
				'length' => 1,
				'blocked' => array (
		...
		array (
			'settings_name' => 'upload_text_display_cut_intro',
			'settings_value' => '1',
			'autoload' => 'yes',
		),
		array (
			'settings_name' => 'upload_text_display_type',
			'settings_value' => 'display_as_image',
			'autoload' => 'yes',
		),
		array (
			'settings_name' => 'upload_text_options',
			'settings_value' => array (
				'font' => 'Abril-Fatface',
				'font_size' => '24',
				'font_color' => '#dbdbdb',
				...
				'bg_gradient_2' => '#000000',
				'bg_gradient_3' => '#000000',
				'bg_gradient_4' => '#000000',
				'bg_image' => '2014_dd_customs_chevrolet_camaro_ss-wide.jpg.png',
				'user_bg' => '0',
				'user_bg_fit' => 'full',
				'user_bg_fit_fill_color' => '#000000',
				'brightness' => 100,
				'padding' => 10,
				'container_height' => 90,
				'length' => '10',
				...
				'set_min_height' => '0',
				'text_shadow' => 1,
				'text_shadow_color' => '#0ec9c6',
				'text_shadow_opacity' => 42,
				'letters' => 'none',
				'user_color' => 1,
				'image_shadow' => 20,
				'shadow' => 1,
		...
		array (
			'settings_name' => 'upload_text_template',
			'settings_value' => '<div class="text-file-wrapper-normal" style="color: #dbdbdb;text-align: center;font-size: 28px;background: url(http://www.skrypt.ips/upload/system/upload_text_bg/activ__2014_vorsteiner_mercedes_benz_c63_amg-wide.png.png)  scroll 0 0 #000000;margin-bottom: 5px; height: 100%;;padding: 10px">{intro_text}</div>',
			'autoload' => 'yes',
		),
		array (
			'settings_name' => 'upload_text_template_demotywator',
			'settings_value' => '<div class="text-file-wrapper" style="color: #dbdbdb;text-align: center;font-size: 28px;background: url(http://www.skrypt.ips/upload/system/upload_text_bg/activ__2014_vorsteiner_mercedes_benz_c63_amg-wide.png.png)  scroll 0 0 #000000;margin-bottom: 5px; height: 100%;;padding: 0px 10px 0px 10px">{intro_text}</div>',
			'autoload' => 'yes',
		),
		array (
			'settings_name' => 'upload_type',
			'settings_value' => array (
				'article' => '1',
				'gallery' => '1',
				'animation' => '1',
		...
		array (
			'settings_name' => 'upload_video_options',
			'settings_value' => array (
				'add_video_layer' => '0',
		...
		array (
			'settings_name' => 'upload_video_type',
			'settings_value' => array (
				'video' => '1',
				'mp4' => '1',
				'swf' => '1',
		...
		array (
			'settings_name' => 'user_account',
			'settings_value' => array (
				'comment_wait_time' => '1',
				'upload_wait_time' => '1',
				'email_activation' => '1',
				'register_captcha' => '1',
				'password_length' => '6,90',
				'login_length' => '3,30',
				'login_cookie_time' => '24',
				'login_cookie_remember_time' => '31',
			),
			'autoload' => 'yes',
		),
		array (
			'settings_name' => 'user_guest_option',
			'settings_value' => array (
				'vote' => '0',
				'comment' => '0',
				'upload' => '1',
		...
		array (
			'settings_name' => 'vines_main_as_file',
			'settings_value' => '1',
			'autoload' => 'yes',
		),
		array (
			'settings_name' => 'vote_file_menu',
			'settings_value' => '6',
			'autoload' => 'yes',
		),
		array (
			'settings_name' => 'wait_counter',
			'settings_value' => '15',
			'autoload' => 'yes',
		),
		array (
			'settings_name' => 'watermark',
			'settings_value' => array (
				'activ' => 0,
				'opacity' => 80,
				'angle' => 38,
		...
		array (
			'settings_name' => 'watermark_options',
			'settings_value' => array (
				'text' => '',
				'text_size' => 18,
				'text_font' => 'PT-Sans',
		...
		array (
			'settings_name' => 'watermark_transparent',
			'settings_value' => array (
				'activ' => '1',
				'opacity' => '80',
				'angle' => '38',
				'file' => 'ODE4_watermark_transparent.png',
			),
			'autoload' => 'yes',
		),
		array (
			'settings_name' => 'web_fonts_config',
			'settings_value' => array (
			),
			'autoload' => 'yes',
		),
		array (
			'settings_name' => 'web_fonts_list',
			'settings_value' => '{
		 ...
		 "items": [
		  ...
		  },
		  {
		   ...
		   "lastModified": "2015-06-03",
		   "files": {
				"500": "http://fonts.gstatic.com/s/istokweb/v9/LLGlByAZO7elm_w5bNr6ki3USBnSvpkopQaUR-2r7iU.ttf",
				"500italic": "http://fonts.gstatic.com/s/istokweb/v9/ycQ3g52ELrh3o_HYCNNUw8CNfqCYlB_eIx7H1TVXe60.ttf",
				"700": "http://fonts.gstatic.com/s/istokweb/v9/2koEo4AKFSvK4B52O_Mwai3USBnSvpkopQaUR-2r7iU.ttf",
				"700italic": "http://fonts.gstatic.com/s/istokweb/v9/ycQ3g52ELrh3o_HYCNNUw3e1Pd76Vl7zRpE7NLJQ7XU.ttf"
		   }
		  },
		  {
		   "kind": "webfonts#webfont",
		  ...
		  },
		  {
		   ...
		   "lastModified": "2015-04-22",
		   "files": {
				"regular": "http://fonts.gstatic.com/s/jaldi/v1/x1vR-bPW9a1EB-BUVqttCw.ttf",
		  ...
		  },
		  {
		   ...
		   "lastModified": "2015-04-22",
		   "files": {
				"regular": "http://fonts.gstatic.com/s/pragatinarrow/v1/HzG2TfC862qPNsZsV_djPpTvAuddT2xDMbdz0mdLyZY.ttf",
		...
		array (
			'settings_name' => 'widget_app_friends',
			'settings_value' => '0',
			'autoload' => 'yes',
		),
		array (
			'settings_name' => 'widget_best_files',
			'settings_value' => '1',
			'autoload' => 'yes',
		),
		array (
			'settings_name' => 'widget_best_files_options',
			'settings_value' => array (
				'source' => 'wait',
				'type' => 'all',
				'limit' => '10',
		...
		array (
			'settings_name' => 'widget_category_panel',
			'settings_value' => '0',
			'autoload' => 'yes',
		),
		array (
			'settings_name' => 'widget_category_panel_view',
			'settings_value' => 'images',
			'autoload' => 'yes',
		),
		array (
			'settings_name' => 'widget_category_panel_view_header',
			'settings_value' => '0',
			'autoload' => 'yes',
		),
		array (
			'settings_name' => 'widget_confirm_email_reminder',
			'settings_value' => '1',
			'autoload' => 'yes',
		),
		array (
			'settings_name' => 'widget_cookie_info',
			'settings_value' => '1',
			'autoload' => 'yes',
		),
		array (
			'settings_name' => 'widget_cookie_info_options',
			'settings_value' => array (
				'template' => 'bottom',
			),
			'autoload' => 'yes',
		...
		array (
			'settings_name' => 'widget_fan_box',
			'settings_value' => '1',
			'autoload' => 'yes',
		),
		array (
			'settings_name' => 'widget_file_tags',
			'settings_value' => '1',
			'autoload' => 'yes',
		),
		array (
			'settings_name' => 'widget_float_box',
			'settings_value' => '1',
			'autoload' => 'yes',
		),
		array (
			'settings_name' => 'widget_float_slides',
			'settings_value' => '0',
			'autoload' => 'yes',
		),
		array (
			'settings_name' => 'widget_float_slides_options',
			'settings_value' => array (
				'slider_class' => '3d',
				'facebook' => '1',
				'google' => '1',
		...
		array (
			'settings_name' => 'widget_go_to',
			'settings_value' => '0',
			'autoload' => 'yes',
		),
		array (
			'settings_name' => 'widget_go_to_top',
			'settings_value' => '1',
			'autoload' => 'yes',
		),
		array (
			'settings_name' => 'widget_history_users_activity',
			'settings_value' => '1',
			'autoload' => 'yes',
		),
		array (
			'settings_name' => 'widget_navigation_bottom',
			'settings_value' => '0',
			'autoload' => 'yes',
		),
		array (
			'settings_name' => 'widget_navigation_bottom_box',
			'settings_value' => '0',
			'autoload' => 'yes',
		),
		array (
			'settings_name' => 'widget_navigation_on_page',
			'settings_value' => '0',
			'autoload' => 'yes',
		),
		array (
			'settings_name' => 'widget_navigation_on_page_box',
			'settings_value' => '0',
			'autoload' => 'yes',
		),
		array (
			'settings_name' => 'widget_only_adult',
			'settings_value' => '0',
			'autoload' => 'yes',
		),
		array (
			'settings_name' => 'widget_personalize',
			'settings_value' => '1',
			'autoload' => 'yes',
		),
		array (
			'settings_name' => 'widget_pinit_related_boards',
			'settings_value' => '1',
			'autoload' => 'yes',
		),
		array (
			'settings_name' => 'widget_pinit_related_pins',
			'settings_value' => '1',
			'autoload' => 'yes',
		),
		array (
			'settings_name' => 'widget_popular_posts',
			'settings_value' => '1',
			'autoload' => 'yes',
		),
		array (
			'settings_name' => 'widget_popular_posts_options',
			'settings_value' => array (
				'source' => 'wait',
				'type' => 'all',
				'limit' => '20',
		...
		array (
			'settings_name' => 'widget_popular_tags',
			'settings_value' => '1',
			'autoload' => 'yes',
		),
		array (
			'settings_name' => 'widget_popular_tags_options',
			'settings_value' => array (
				'count' => '6',
				'header' => '0',
			),
		...
		array (
			'settings_name' => 'widget_popular_tags_wait',
			'settings_value' => '0',
			'autoload' => 'yes',
		),
		array (
			'settings_name' => 'widget_popup',
			'settings_value' => '1',
			'autoload' => 'yes',
		),
		array (
			'settings_name' => 'widget_popup_options',
			'settings_value' => array (
				'close' => '1',
				'close_timer' => '30',
				'box_like' => '1',
				'timeout' => '30',
				'delay' => '0',
				'title' => 'widget_popup_title_content',
				'message' => 'widget_popup_message',
				'theme' => 'gradient',
			),
			'autoload' => 'yes',
		),
		array (
			'settings_name' => 'widget_search_bar',
			'settings_value' => '1',
			'autoload' => 'yes',
		),
		array (
			'settings_name' => 'widget_see_more',
			'settings_value' => '1',
			'autoload' => 'yes',
		),
		array (
			'settings_name' => 'widget_see_more_options',
			'settings_value' => array (
				'layout' => 'one',
				'source' => 'rand',
				'limit' => '3',
		...
		array (
			'settings_name' => 'widget_side_action_button',
			'settings_value' => '1',
			'autoload' => 'yes',
		),
		array (
			'settings_name' => 'widget_small_posts',
			'settings_value' => '1',
			'autoload' => 'yes',
		),
		array (
			'settings_name' => 'widget_smilar_url',
			'settings_value' => '1',
			'autoload' => 'yes',
		),
		array (
			'settings_name' => 'widget_social_share',
			'settings_value' => '0',
			'autoload' => 'yes',
		),
		array (
			'settings_name' => 'widget_sort_box',
			'settings_value' => '1',
			'autoload' => 'yes',
		),
		array (
			'settings_name' => 'widget_sort_box_social',
			'settings_value' => '1',
			'autoload' => 'yes',
		),
		array (
			'settings_name' => 'widget_top_comments',
			'settings_value' => '1',
			'autoload' => 'yes',
		),
		array (
			'settings_name' => 'widget_top_comments_options',
			'settings_value' => array (
				'count' => '1',
				'sort' => 'comment_votes',
			),
		...
		array (
			'settings_name' => 'widget_top_files_right',
			'settings_value' => '0',
			'autoload' => 'yes',
		),
		array (
			'settings_name' => 'widget_top_files_right_main',
			'settings_value' => '0',
			'autoload' => 'yes',
		),
		array (
			'settings_name' => 'widget_top_files_right_wait',
			'settings_value' => '0',
			'autoload' => 'yes',
		),
		array (
			'settings_name' => 'widget_url_copy',
			'settings_value' => '0',
			'autoload' => 'yes',
		),
		array (
			'settings_name' => 'widget_user_idle',
			'settings_value' => '1',
			'autoload' => 'yes',
		),
		array (
			'settings_name' => 'widget_user_idle_options',
			'settings_value' => array (
				'ad_content' => '',
			),
			'autoload' => 'yes',
