...
class Page_Controller
{
	...
	public function route()
	{
		...
		$page_type = get_input( 'page-route' );

		$routes = $page->routes( get_input( 'routes' ) );

		if( empty( $routes['post_permalink'] ) )
		{
			return $page->displayAll( $page_type );
		}
		
		return $page->display( $routes['post_permalink'] );
